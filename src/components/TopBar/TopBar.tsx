...
export class TopBar extends React.Component<ITopBarProps> {
	...
	public render = () => {
		return (
			<>
				<div className='flex items-center basis-16 flex-shrink-0 z-10 gap-3 py-4 bg-base-800 shadow-md'>
					<IconButton
						icon={<Icons.Bars3Solid />}
						onClick={this.handleClickSidebar}
						className='ml-4'
					/>
					<span className='text-lg font-bold text-base-200'>Template</span>
					<ul className='flex items-center flex-shrink-0 ml-auto px-4 gap-3'>
						<ProfileMenu
							label='Menu'
