	...
	private renderRows = () => {
		...
		const robots: JSX.Element[] = [
			<Row>
				...
				<Cell className='text-sm'>06/27/2008</Cell>
			</Row>,
			<Row>
				<Cell>
					<ProfileCard
				...
				<Cell className='text-sm'>04/30/2008</Cell>
			</Row>,
			<Row>
				<Cell>
					<ProfileCard
				...
				<Cell className='text-sm'>05/24/1972</Cell>
			</Row>,
			<Row>
				<Cell>
					<ProfileCard
				...
				<Cell className='text-sm'>03/28/1999</Cell>
			</Row>,
			<Row>
				<Cell>
					<ProfileCard
				...
				<Cell className='text-sm'>03/03/1956</Cell>
			</Row>,
			<Row>
				<Cell>
					<ProfileCard
				...
				<Cell className='text-sm'>09/17/1984</Cell>
			</Row>,
			<Row>
				<Cell>
					<ProfileCard
				...
				<Cell className='text-sm'>04/02/1968</Cell>
			</Row>,
			<Row>
				<Cell>
					<ProfileCard
				...
				<Cell className='text-sm'>08/26/1984</Cell>
			</Row>,
			<Row>
				<Cell>
					<ProfileCard
				...
				<Cell className='text-sm'>05/25/1977</Cell>
			</Row>,
		];

		return <>{robots.slice(x, y)}</>;
	};
